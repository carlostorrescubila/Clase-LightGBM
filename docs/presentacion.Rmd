...
verbosity_cards <- tagList(
  ...
  tags$div(
    ...
    tags$strong("2"),
    tags$p("Muestra información del progreso del entrenamiento.")
  ),
  tags$div(
    style = card_style,
    tags$div(style = icon_style("#ede9fe", "#6b21a8"), "🧠"),
    tags$strong("3+"),
    tags$p("Modo detallado. Útil para debugging profundo.")
  )
)
...
| ----------------------- | -------------- |
| Pequeño (<10,000 filas) | 10–50          |
| Mediano                 | 100–500        |
| Grande                  | 500–1000 o más |
