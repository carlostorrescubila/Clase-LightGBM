...
html <- tags$div(
  ...
  lapply(list(
    ...
    list(nombre = "LinkedIn", uso = "Ranking", logo = "https://upload.wikimedia.org/wikipedia/commons/a/aa/LinkedIn_2021.svg", detalle = "Ordenar resultados de búsqueda y recomendaciones de empleo"),
